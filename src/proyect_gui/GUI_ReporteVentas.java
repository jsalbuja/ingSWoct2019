...
public class GUI_ReporteVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        total_recaudacion = new javax.swing.JTextField();
        total_boletos = new javax.swing.JTextField();
        ...
        getContentPane().add(btn_repVenta_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 370, 87, 35));
        ...
        jLabel4.setText("Total recaudación:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 380, -1, 20));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText("Total boletos vendidos:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, -1, 20));

        total_recaudacion.setEditable(false);
        total_recaudacion.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        total_recaudacion.setText("0.00");
        getContentPane().add(total_recaudacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 380, 70, -1));

        total_boletos.setEditable(false);
        total_boletos.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        total_boletos.setText("0");
        getContentPane().add(total_boletos, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 380, 40, 20));
    ...
    private void GeneraReporte() throws ParseException {
        ...
        try {
            ...
            try (FileReader fr = new FileReader(Entorno.RutaBoletos);
                ...
                while ((d = br.readLine()) != null) {
                    ...
                    if (FechaBoleto.compareTo(FechaInicio) >= 0 && FechaBoleto.compareTo(FechaFinal) <= 0) {
                        ...
                        TotBoletos += Double.parseDouble(x.get(1).toString());
                        TotPasajes += Double.parseDouble(x.get(5).toString());
            ...
            total_boletos.setText(String.valueOf(TotBoletos));
            total_recaudacion.setText(String.valueOf(TotPasajes));
    ...
    private javax.swing.JTextField total_boletos;
    private javax.swing.JTextField total_recaudacion;
